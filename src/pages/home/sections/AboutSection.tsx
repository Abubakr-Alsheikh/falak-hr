      ...
      <div className="container mx-auto mb-16 overflow-hidden">
        <FadeIn direction="up">
          <HeaderSection
            ...
            text="فلك للموارد البشرية هي شركة رائدة في تقديم حلول مبتكرة لإدارة الموارد البشرية، متخصصة في تمكين العمل عن بعد. نهدف إلى دعم الشركات في تحقيق أهدافها من خلال توفير حلول تقنية متكاملة لإدارة الموظفين، وتنمية الكفاءات، وتعزيز الإنتاجية."
          />
        </FadeIn>
