  ...
  const accountData = [
    {
      ...
      routePath: "/remote-work", // New internal route path
    ...
    },
    {
      ...
      routePath: "/subscription", // New internal route path
          ...
          {accountData.map((account, index) => (
            <ScaleUp key={index} delay={index * 0.4}>
              <AccountCard
                ...
                routePath={account.routePath} // Pass the new internal route
              />
            </ScaleUp>
          ))}
        </div>
