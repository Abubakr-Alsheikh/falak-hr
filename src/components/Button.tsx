...
const Button: React.FC<ButtonProps> = ({
  ...
  let buttonClasses =
    variant === "primary"
      ...
      : "flex justify-center items-center transition-colors text-secondary-500 border border-secondary-500 text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 ";
