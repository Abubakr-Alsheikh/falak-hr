...
interface CompanyFormProps {
  ...
  const CompanyForm: React.FC<CompanyFormProps> = ({
    ...
    const handleParentCompanySelect = (company: Company | null, setFieldValue: (field: string, value: any) => void) => {
            ...
            <Form>
              <div className="mb-4 grid gap-4 sm:grid-cols-2">
                ...
                <ParentCompanySelect
                    ...
                    onSelect={(company) => handleParentCompanySelect(company, setFieldValue)}
